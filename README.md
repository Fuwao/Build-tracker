...
QR発行ページでラベルサイズを3段階から選べます。

| サイズ | 用途 | ラベル幅 | QRサイズ | 表示情報 |
|---|---|---|---|---|
| 小 | 工具に貼る | 約45mm | 約28mm | QR・管理番号・物品名 |
| 中 | ケース・箱に貼る | 約65mm | 約40mm | 小 + 状態 |
| 大 | 掲示・管理表 | 約95mm | 約65mm | 中 + 現在地・QR URL |

小サイズは情報量を絞っていますが、印刷後は必ずスマホで読み取れるか確認してください。
